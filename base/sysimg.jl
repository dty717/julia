...
@eval Base begin
    ...
    @deprecate_binding REPLCompletions root_module(:REPL).REPLCompletions true ", use `REPL.REPLCompletions` instead"
    @deprecate_binding Terminals       root_module(:REPL).Terminals       true ", use `REPL.Terminals` instead"
end
